...
<InventoryList>
  ...
  <InventoryItem
    ...
    alt="iphone"
    title="iPhone 14"
    description="First iPhone I bought. I love it so far."
  />
  ...
  <InventoryItem
    href="https://www.withings.com/sleep-analyzer"
    img="/assets/images/inventory/withings-sleep.png"
    alt="withings sleep analyzer"
    title="Withings Sleep Analyzer"
    description="The precision is always average on this kind of device, but it's the only one where you don't have to wear anything on you."
  />
