---
publicationDatetime: 2025-07-18T07:56:00.000Z
updateDatetime: 2025-07-18T07:56:00.000Z
...
logo: ../../assets/images/projects/github-breakout.png
...
<div className="dark:hidden">
  ![Breakout SVG](assets/images/projects/github-breakout/custom-light.svg)
</div>
<div className="hidden dark:block">
  ![Breakout SVG](assets/images/projects/github-breakout/custom-dark.svg)
</div>

You can also disable ghost bricks for days without activity, so all days count as a brick:

<div className="dark:hidden">
  ![Breakout SVG](assets/images/projects/github-breakout/light-no-ghost.svg)
</div>
<div className="hidden dark:block">
  ![Breakout SVG](assets/images/projects/github-breakout/dark-no-ghost.svg)
</div>
